def main():
    ...
    for number in list_of_bingos:
        ...
        for mat in matrixes:
            ...
            c_key = "c_"+str(m)
            sum_key = "s_"+str(m)
            process_mat(mat, number, mat_name, r_dict, r_key, c_dict, c_key, sum_dict, sum_key)
            m+=1
    print("konec_programu")

def process_mat(mat, number, mat_name, r_dict, r_key, c_dict, c_key, sum_dict, sum_key):
